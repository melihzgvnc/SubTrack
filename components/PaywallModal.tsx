...
export const PaywallModal: React.FC<Props> = ({ visible, onClose }) => {
    ...
    const features = [
        ...
        t('paywall.features.sync'),
        t('paywall.features.icons'),
        t('paywall.features.support')
    ];
                    ...
                    <View style={{ flex: 1, paddingTop: isTablet ? 48 : 48, paddingHorizontal: horizontalPadding, paddingBottom: 32 }}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <View className="items-center mb-8">
                                ...
                                >
                                    {t('paywall.unlock')} <Text style={{ color: colors.accent.primary, fontFamily: typography.fontFamily.display }}>{t('paywall.pro')}</Text>
                                </Text>
                                <Text
                            ...
                            <TouchableOpacity onPress={restorePurchases} className="items-center py-4">
                                <Text className="text-gray-400 font-medium">{t('paywall.restore')}</Text>
                            </TouchableOpacity>

                            <View className="flex-row justify-center gap-6 mt-2">
                                <Text className="text-gray-500 text-xs">{t('paywall.terms')}</Text>
                                <Text className="text-gray-500 text-xs">{t('paywall.privacy')}</Text>
                            </View>
